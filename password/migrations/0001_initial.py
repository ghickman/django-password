...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('password_password', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incunapassword_employee_related', to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        'password.password': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'incunapassword_employee_related'", 'to': "orm['auth.User']"}),
